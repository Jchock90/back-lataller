...
const actitivies = [{
    ...
    module_id: "National Park Roraima"
},{
    ...
    module_id: "Veligandu Island Beach"
},{
    name: "Beach Spa",
    ...
    module_id: "Angkor Wats Temple Complex"
},{
...
async function creatActivities(arrayActivities) {
    ...
    try {
        ...
        for (let activity of arrayActivities) {
            let module = await Module.findOne( {name: activity.module_id} )
            let module_id = await module._id
